...
namespace FastExpressionEngine.ExpressionBuilders
{
    ...
    {
        private readonly EngineSetting _setting;
        private readonly IDictionary<string, MethodInfo> _methodInfo;

        public RuleExpressionParser(EngineSetting setting)
        {
            _setting = setting;
        ...
        {
            var dict_add = typeof(Dictionary<string, object>).GetMethod("Add",
        ...
        public Expression Parse(string expression, ParameterExpression[] parameters, Type returnType)
        {
            ...
            {
                CustomTypeProvider = new CustomTypeProvider(_setting.CustomTypes),
        ...
        public Func<object[], T> Compile<T>(string expression, RuleParameter[] ruleParams)
        {
            ...
            var wrappedExpression =
                WrapExpression<T>(expressionBody, parameterExpressions, new ParameterExpression[] { });
